...
import 'package:from_zero_ui/util/copied_flutter_widgets/time_picker_dialog_from_zero.dart'
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              if (enabled && !showClearButton) const Icon(Icons.arrow_drop_down),
              const SizedBox(
                width: 4,
              ),
            ],
          ...
          children: [
            ...
            ResponsiveHorizontalInsets(
              ...
              child: CalendarDatePicker(
                //DatePickerDialog shows a material one, but it's just unnecessarily more complicated
