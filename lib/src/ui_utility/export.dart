...
class Export extends StatefulWidget {
  ...
  static final List<PdfPageFormat> defaultFormats = [
  ...
  void initState() {
    ...
    if (widget.scrollableChildBuilder != null) {
      widget.childrenCount = ((currentSize, bool portrait, double scale, String format) {
        ...
        if (currentSize == lastSize && portrait == lastPortrait && scale == lastScale && format == lastFormat) {
            ...
            if (significantWidgetVisibleAtStartOffsets[i] > jumpsSeparatingPages.last + position.viewportDimension) {
              ...
              pageBottomPaddings.add(
                position.viewportDimension -
                    (significantWidgetVisibleAtStartOffsets[i - 1] -
                      ...
                      if ((widget.childrenCount?.call(
                        ...
                        CirclePageIndicator(
                          ...
                          onPageSelected: (value) =>
                              controller.animateToPage(value, duration: 300.milliseconds, curve: Curves.easeOut),
                          size: 10,
                          selectedSize: 12,
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: DialogButton(
                          leading: const Icon(
                            MaterialCommunityIcons.presentation_play,
                            color: Colors.blue,
                          ),
                          color: Colors.blue,
                          onPressed: () async {
