      ...
      builder: (context, constraints) {
        ...
        if (widget.anchorKey != null) {
          try {
            ...
            referencePosition = box.localToGlobal(
              Offset.zero,
              ancestor: widget.anchorKey!.currentContext!
                  .findAncestorStateOfType<SnackBarHostFromZeroState>()
                  ?.context
                  .findRenderObject(), // hack to support UI scale
        ...
        double popupWidth =
            widget.width ?? (referenceSize == null ? 312 : (referenceSize.width + 8).clamp(312, double.infinity));
              ...
              children: [
                AnimatedPositioned(
                  ...
                  child: Card(
                    ...
                    child: OverflowBox(
                      alignment: animation.isCompleted ? Alignment.topCenter : popupAlignment,
                      minWidth: popupWidth,
                      maxWidth: popupWidth,
                      minHeight: 0,
                      maxHeight: maxHeight,
