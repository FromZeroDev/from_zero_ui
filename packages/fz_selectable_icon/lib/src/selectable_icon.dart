...
class _SelectableIconState extends State<SelectableIcon> with SingleTickerProviderStateMixin {
  ...
  void initTurnsAnimation() {
    _iconTurns = _curvedAnimation!.drive(
      Tween<double>(
  ...
  void initColorAnimation() {
    _iconColor = _curvedAnimation!.drive(
      ColorTween(
        begin: widget.unselectedColor ?? Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.75),
        end: widget.selectedColor ?? Theme.of(context).colorScheme.secondary,
      ),
    );
  }
