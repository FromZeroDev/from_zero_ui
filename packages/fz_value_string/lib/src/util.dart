...
class ValueStringLazy<T> extends ValueString<T> {
  ...
  ValueStringLazy(T value, this.toStringFunction) : super(value, '');
...
bool isVisibleInScrollable(BuildContext currentContext, double currentScrollPixels) {
  ...
  if (offsetToRevealBottom.offset > currentScrollPixels || currentScrollPixels > offsetToRevealTop.offset) {
    return false;
  }
  return true;
}
