...
enum ScaffoldTypeAnimation { same, other, inner, outer }

enum AppbarType { none, static, collapse, quickReturn }

enum ScrollBarType { none, belowAppbar, overAppbar }
...
class ScaffoldFromZeroState extends ConsumerState<ScaffoldFromZero> {
  ...
  void dispose() {
    super.dispose();
    _changeNotifier.drawerContentScrollOffsets[pageScaffoldId]?.removeListener(
      _onDrawerScrollOffsetChanged,
    );
        ...
        Widget result = Stack(
          children: [
            ...
            screen.isMobileLayout ||
                    ...
                    PlatformExtended
                        .isDesktop // this should be if no mouse, instead of platform based
  ...
  Widget _getBody(
    ...
    var changeNotifierNotListen = ref.read(
      fromZeroScaffoldChangeNotifierProvider,
    );
    Widget body = Align(
                              ...
                              if ((widget.useCompactDrawerInsteadOfClose &&
                                ...
                                if (canPop &&
                                  ...
                                  final iconButtonColor =
                                      Theme.of(
                                        context,
                                      ).appBarTheme.toolbarTextStyle?.color ??
                                      (Theme.of(
                                        context,
                ...
                return Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: const CustomPaint(
                        painter: SimpleShadowPainter(
                          direction: SimpleShadowPainter.up,
                          shadowOpacity: 0.4,
                        ),
                      ),
                    ),
  ...
  Widget _getResponsiveDrawerContent(
    ...
    return Consumer(
      builder: (context, ref, child) {
        final appbarChangeNotifier = ref.read(
          fromZeroAppbarChangeNotifierProvider,
        );
        final changeNotifierNotListen = ref.read(
          fromZeroScaffoldChangeNotifierProvider,
