...
class _DayPeriodControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color textColor =
        timePickerTheme.dayPeriodTextColor ??
        WidgetStateColor.resolveWith((Set<WidgetState> states) {
          return states.contains(WidgetState.selected)
              ? colorScheme.primary
    ...
    final Color backgroundColor =
        timePickerTheme.dayPeriodColor ??
        WidgetStateColor.resolveWith((Set<WidgetState> states) {
...
class _HourMinuteTextFieldState extends State<_HourMinuteTextField> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final String? hintText =
        MediaQuery.accessibleNavigationOf(context) || WidgetsBinding.instance.window.semanticsEnabled
  ...
  Widget buildWithOrientation(BuildContext context, [Orientation? orientation]) {
    ...
    final Widget actions = Row(
      children: <Widget>[
        ...
        IconButton(
          color:
              TimePickerTheme.of(context).entryModeIconColor ??
