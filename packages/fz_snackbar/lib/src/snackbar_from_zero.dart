...
import 'package:fz_snackbar/src/snackbar_host_from_zero.dart';
...
class SnackBarFromZero extends ConsumerStatefulWidget {
  ...
  SnackBarControllerFromZero show({
    ...
    controller = SnackBarControllerFromZero(host: host, snackBar: this);
    host.show(this);
    return controller!;
  }
...
class SnackBarFromZeroState extends ConsumerState<SnackBarFromZero> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
          ...
          child:
              ...
              Column(
                ...
                children: [
                  ...
                  if (widget.message != null) const SizedBox(height: 2),
            ...
            child: ConstrainedBox(
              ...
              child: IntrinsicWidth(
                child: Column(
                  ...
                  children: [
                    if (widget.actions!.length > 1) const SizedBox(height: 6),
    ...
    Color backgroundColor = type == null
        ...
        : Color.alphaBlend(
            SnackBarFromZero.colors[type].withValues(alpha: 0.066),
            Theme.of(context).cardColor,
          );
    if (fixed) {
      result = Material(color: backgroundColor, elevation: 0, child: result);
    } else {
      result = Card(
    ...
    result = IconTheme(
      data: Theme.of(context).iconTheme.copyWith(color: actionColor, size: 32),
      child: result,
    );
    return result;
  }
