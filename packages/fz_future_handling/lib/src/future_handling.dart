                            ...
                            child: DecoratedBox(
                              decoration: BoxDecoration(
                                ...
                                gradient: RadialGradient(
                                  ...
                                  stops: [
                                    0,
                                    0.25 + (0.75 * loopingAnimation.value),
                                    1,
                                  ],
                                ),
                              ),
    ...
    final retryWidget = retryButton == null && onRetry == null
        ...
        : (retryButton ??
              DialogButton.accept(
                ...
                onPressed: onRetry,
                child: Text(
                  FromZeroLocalizations.of(context).translate("retry"),
                ),
              ));
    ...
    if (!compact) {
      result = Column(
        ...
        children: [
          ...
          if (iconWidget != null) const SizedBox(height: 16),
          titleWidget,
          if (subtitleWidget != null) const SizedBox(height: 8),
          if (subtitleWidget != null) subtitleWidget,
          if (retryWidget != null) const SizedBox(height: 16),
      ...
      child: Align(
        ...
        child: ScrollbarFromZero(
          ...
          child: SingleChildScrollView(
            controller: scrollController,
            child: SizedBox(width: 512, child: result),
          ),
        ),
      ),
    );
...
class FutureBuilderFromZero<T> extends StatefulWidget {
  ...
  static Widget defaultTransitionBuilder(
    ...
    return ZoomedFadeInFadeOutTransition(animation: animation, child: child);
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (size == null) {
          return buildResult(context, child: child);
        } else {
