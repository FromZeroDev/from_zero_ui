                                    ...
                                    children: [
                                      ...
                                      TooltipFromZero(
                                        message: FromZeroLocalizations.of(
                                          context,
                                        ).translate('add_condition_filter'),
                                        child: PopupMenuButton<ConditionFilter>(
                                          ...
                                          itemBuilder: (context) {
                                            return possibleConditionFilters.map((
                                              e,
                                            ) {
                                  ...
                                  return Padding(
                                    ...
                                    child: e.buildFormWidget(
                                      ...
                                      onDelete: () {
                                        modified.value = true;
                                        filterPopupSetState(() {
                                          newConditionFilters[colKey]!.remove(
                                            e,
                                          );
                                        });
                                      },
                                    ...
                                    SizedBox(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText: FromZeroLocalizations.of(
                                            context,
                                          ).translate('search...'),
